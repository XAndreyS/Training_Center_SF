...
"""Цикл for может работать не только со списками, но и со строками и словарями. Давайте рассмотрим
 задачу для подсчета количества символов в тексте.
...
"""Заводим переменную «счетчик» в виде словаря, где по ключу будет храниться символ, по значению — его количество. 
