#Continue
"""Если в прошлый раз мы рассмотрели ключевое слово break, которое дострочно прерывает выполнение цикла,
то сейчас рассмотрим ключевое слово continue. Если в теле цикла встречается ключевое слово continue, то цикл пропускает
 весь код до конца тела цикла и переходит на следующий шаг.

Рассмотрим следующую задачу. В клетке находятся фазаны и кролики. Известно, что у них 35 голов и 94 ноги. Узнайте число
...
Количество фазанов и кроликов выражается целым числом, поэтому будем перебирать все возможные комбинации количества
 кроликов и фазанов, и если суммарное количество их ног равно указанному в условии, то мы нашли одно из решений."""
